...
<body>
	...
	<form id="theForm" method="post" style="width: 100%">
		<input type="hidden" id="hj_area" name="hj_area"
			value="${accountInfo.staffInfo.AREA_CODE}" /><input type="hidden"
			id="job_area" name="job.job_area" />
		<div class="easyui-panel" style="width: 100%"
			...
			<table style="width: 100%">
				...
				<tr>
					...
					<td style="width: 20%; text-align: left"><input
						class="easyui-textbox" name="qq" style="width: 100%" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="width: 50%; text-align: left" colspan="3"><input
						...
						data-options="prompt:'多个技能类型之间用逗号分开'" /></td>
						...
						.combobox(
								{
									...
									required : true,
									validType : [ 'equalTriggerRequired["是", "job_dw", "job_time", "job_gw", "job_area_name", "job_area", "job_industry", "job_type"]' ],
